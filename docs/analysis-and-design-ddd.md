...
**E-Mid Quiz (this repository):** The team used **SOA / process decomposition** only. The completed submission document is **[`analysis-and-design.md`](analysis-and-design.md)**. This DDD template is **left unfilled** on purpose; you may reuse it for other courses or if the instructor explicitly requests an event-storming style write-up.
